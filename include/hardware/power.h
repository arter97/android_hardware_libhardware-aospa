...
typedef enum {
    ...
    POWER_FEATURE_ONE_FINGER_SWIPE_DOWN = 0x0000000A,
    POWER_FEATURE_ONE_FINGER_SWIPE_LEFT = 0x0000000B,
    POWER_FEATURE_TWO_FINGER_SWIPE_UP = 0x0000000C,
    POWER_FEATURE_TWO_FINGER_SWIPE_DOWN = 0x0000000D
} feature_t;
