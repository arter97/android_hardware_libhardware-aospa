...
typedef enum {
    ...
    POWER_FEATURE_DRAW_V = 0x00000002,
    POWER_FEATURE_DRAW_O = 0x00000003,
    POWER_FEATURE_DRAW_M = 0x00000004,
    POWER_FEATURE_DRAW_W = 0x00000005,
    POWER_FEATURE_DRAW_ARROW_LEFT = 0x00000006,
    POWER_FEATURE_DRAW_ARROW_RIGHT = 0x00000007,
    POWER_FEATURE_TWO_FINGER_SWIPE_UP = 0x00000008,
    POWER_FEATURE_TWO_FINGER_SWIPE_DOWN = 0x00000009
} feature_t;
